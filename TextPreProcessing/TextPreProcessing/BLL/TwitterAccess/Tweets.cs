        ...
        public async Task GetTweetsOfTrendFromTwitter(String trend)
        {
            ...
            var searchResponse =
                ...
                (from search in twitterContext.Search
                 where search.Type == SearchType.Search && search.GeoCode == "30.441851,69.359703,500mi" &&
                       search.Query == trend
                 select search)
                .SingleOrDefaultAsync();

            if (searchResponse != null && searchResponse.Statuses != null)
                searchResponse.Statuses.ForEach(tweet => tweetList.Add(new Tweets(tweet.Text, tweet.User.Name, trend, tweet.CreatedAt)));
